...
export const PennyItemHUD: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-purple-950/40 via-[#0e1320] to-[#0e1320] border border-purple-500/30 shadow-xl">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-300 mt-1 max-w-3xl leading-relaxed">
              Demystifying viral $0.01 glitch videos, decoding internal retail tag markdown matrices, eliminating phantom ghost inventory wasted trips, and maximizing 50%+ profit real-world arbitrage.
            </p>
          </div>
        </div>

        {/* Sub-tabs */}
        <div className="flex flex-wrap gap-2 mt-6 pt-5 border-t border-purple-500/20 text-xs">
          <button
            ...
            className={`px-4 py-2 rounded-xl font-bold transition-all duration-200 ${
              activeTab === 'codes'
                ...
                : 'bg-[#07090e] text-slate-300 hover:text-white border border-slate-800'
            }`}
          >
      ...
      {activeTab === 'codes' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {/* Home Depot */}
          <div className="p-5 rounded-3xl bg-[#0e1320] border border-slate-800 space-y-3 shadow-lg">
            <div className="flex items-center justify-between pb-2 border-b border-slate-800/80">
              <span className="font-extrabold text-sm text-amber-400 font-display">The Home Depot Price Ending Codes</span>
              <span className="text-[10px] font-mono text-slate-400 bg-[#07090e] px-2 py-0.5 rounded border border-slate-800">Yellow Tag Matrix</span>
            </div>
            <ul className="text-xs space-y-2.5 text-slate-300">
              <li className="p-3 rounded-2xl bg-[#07090e] border border-slate-800/80">
              ...
              <li className="p-3 rounded-2xl bg-purple-950/30 border border-purple-500/30">
          ...
          <div className="p-5 rounded-3xl bg-[#0e1320] border border-slate-800 space-y-3 shadow-lg">
            <div className="flex items-center justify-between pb-2 border-b border-slate-800/80">
              <span className="font-extrabold text-sm text-red-400 font-display">Target Markdown Tag Matrix</span>
              <span className="text-[10px] font-mono text-slate-400 bg-[#07090e] px-2 py-0.5 rounded border border-slate-800">Small Yellow Square</span>
            </div>
            <ul className="text-xs space-y-2.5 text-slate-300">
              <li className="p-3 rounded-2xl bg-[#07090e] border border-slate-800/80">
              ...
              <li className="p-3 rounded-2xl bg-emerald-950/30 border border-emerald-500/30">
          ...
          <div className="p-5 rounded-3xl bg-[#0e1320] border border-slate-800 space-y-3 shadow-lg">
            <div className="flex items-center justify-between pb-2 border-b border-slate-800/80">
              <span className="font-extrabold text-sm text-blue-400 font-display">Costco Wholesale Price Signs</span>
              <span className="text-[10px] font-mono text-slate-400 bg-[#07090e] px-2 py-0.5 rounded border border-slate-800">Coralville / Regional</span>
            </div>
            <ul className="text-xs space-y-2.5 text-slate-300">
              <li className="p-3 rounded-2xl bg-[#07090e] border border-slate-800/80">
              ...
              <li className="p-3 rounded-2xl bg-amber-950/30 border border-amber-500/30">
          ...
          <div className="p-5 rounded-3xl bg-[#0e1320] border border-slate-800 space-y-3 shadow-lg">
            <div className="flex items-center justify-between pb-2 border-b border-slate-800/80">
              <span className="font-extrabold text-sm text-emerald-400 font-display">Menards Ray's List & 11% Rebate Stack</span>
              <span className="text-[10px] font-mono text-slate-400 bg-[#07090e] px-2 py-0.5 rounded border border-slate-800">Cedar Falls Store</span>
            </div>
            <ul className="text-xs space-y-2.5 text-slate-300">
              <li className="p-3 rounded-2xl bg-[#07090e] border border-slate-800/80">
      ...
      {activeTab === 'ghost_reality' && (
        <div className="p-6 rounded-3xl bg-[#0e1320] border border-slate-800 space-y-5 shadow-xl">
          <h3 className="font-extrabold text-base sm:text-lg text-white flex items-center gap-2 font-display">
            <AlertTriangle className="w-5 h-5 text-amber-400" />
            <span>Why 95% of Viral "Penny Item" Lists Are Phantom Inventory (Ghost Stock)</span>
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            <div className="p-4 rounded-2xl bg-[#07090e] border border-slate-800 space-y-2.5">
              <div className="font-bold text-red-400 flex items-center gap-1.5 text-sm font-display">
            ...
            <div className="p-4 rounded-2xl bg-[#07090e] border border-slate-800 space-y-2.5">
              <div className="font-bold text-emerald-400 flex items-center gap-1.5 text-sm font-display">
        ...
        <div className="p-6 rounded-3xl bg-[#0e1320] border border-slate-800 space-y-4 shadow-xl">
          ...
          <div className="space-y-3.5 text-xs text-slate-300 leading-relaxed">
            <div className="p-4 rounded-2xl bg-[#07090e] border border-slate-800">
              <strong className="text-amber-300 block mb-1 font-semibold text-sm">Why Dollar General has more penny items than any other chain:</strong>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div className="p-4 rounded-2xl bg-[#07090e] border border-slate-800">
                <span className="font-bold text-white block mb-1 text-sm font-display">The Symbol / Dot System:</span>
              ...
              <div className="p-4 rounded-2xl bg-[#07090e] border border-slate-800">
                <span className="font-bold text-white block mb-1 text-sm font-display">In-Store Scanning Secret:</span>
        ...
        <div className="p-6 rounded-3xl bg-[#0e1320] border border-slate-800 space-y-4 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            <div className="p-5 rounded-2xl bg-[#07090e] border border-slate-800 space-y-2.5">
              <div className="font-bold text-amber-300 text-sm font-display">Self-Checkout vs. Cashier Guidelines:</div>
            ...
            <div className="p-5 rounded-2xl bg-[#07090e] border border-slate-800 space-y-2.5">
              <div className="font-bold text-emerald-400 text-sm font-display">Winning Flipping Etiquette:</div>
              <ul className="list-disc list-inside space-y-2 text-slate-300 leading-relaxed">
